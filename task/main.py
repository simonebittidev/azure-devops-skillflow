...
def main() -> None:
    ...
    from src.tools.azdo_tools import AzDOClient, SKILLFLOW_PR_MARKER
    ...
    # --- Loop prevention: skip if this PR was generated by SkillFlow ---
    try:
        _pr_description = AzDOClient(ctx).get_pr_description()
        if SKILLFLOW_PR_MARKER in _pr_description:
            print("##vso[task.logissue type=warning]This PR was generated by SkillFlow — skipping skill execution to prevent infinite pipeline loops.")
            print("##vso[task.complete result=Succeeded]Skipped (SkillFlow-generated PR).")
            return
    except Exception as exc:
        print(f"##vso[task.logissue type=warning]Could not check PR description for loop prevention marker: {exc}")
